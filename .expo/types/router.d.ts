...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/carousel/carouselScreen ` | `/carousel/carouselScreen ` | `/(tabs)/carousel/firstSlide` | `/carousel/firstSlide` | `/(tabs)/carousel/secondSlide` | `/carousel/secondSlide` | `/(tabs)/carousel/thirdSlide` | `/carousel/thirdSlide` | `/(tabs)/homeScreen` | `/homeScreen` | `/(tabs)/` | `/(tabs)` | `/+html`;
  // prettier-ignore
